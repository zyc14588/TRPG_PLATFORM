...
| `apps/agent-worker/src/main.rs` | 32267 | `6363463dc34b191badbe75567fba45bbeac12b4389ca68420140c0d9b7e6022d` | `100644` |
...
| `apps/api-server/src/lib.rs` | 57544 | `edb68597d7ba2a0c2f9d06527bb79e1859521424011badbde22742dceaa05445` | `100644` |
| `apps/api-server/src/main.rs` | 18537 | `207dc7a6af108f8c1933dc21924a65a2555204b049b1c95812a1748cc0a9c99c` | `100644` |
...
| `apps/api-server/src/player_action.rs` | 30607 | `7d6f07f06e94db0bfd64f844ea5888257bbb6f4462f23f3eb78167da2e9df658` | `100644` |
| `apps/api-server/src/production_custody_tests.rs` | 13886 | `119167b76f4df6a3d42de93c0b983fd87f19080e3ff64395843e260a882017ff` | `100644` |
| `apps/api-server/tests/auth_http_integration.rs` | 14147 | `7d9a3145fcec9a187f6b5a8f198062ada176490d2912b2f74d498d9e8731a22d` | `100644` |
...
| `crates/trpg-agent-runtime/src/agent_runtime.rs` | 35040 | `0044b4f42f505a0439f05fce545fdd3252f60d47917bc30729c631999ad096ea` | `100644` |
...
| `crates/trpg-agent-runtime/src/local_model_certification.rs` | 16310 | `5658caea7609399cc35765c96235a8d9ad8feade97cefe2bed7bd06520aca6d5` | `100644` |
...
| `crates/trpg-agent-runtime/tests/batch_017_agent_runtime_contract_tests.rs` | 29209 | `9c558ee9855af410c332e17d5845dce61236a1ee3968cbeec008ad33f7f190f2` | `100644` |
...
| `crates/trpg-api/src/api_contracts.rs` | 25190 | `95fcc5d283c3c3782b8e65541acff0db40033164ecf53e6c0a7a05283a554b0d` | `100644` |
...
| `crates/trpg-api/src/contract_core.rs` | 19288 | `49e929bf4d8fde49a8a682af996ada90a6516dbb1219cbda48de3dd939807040` | `100644` |
...
| `crates/trpg-api/tests/campaign_character_api_integration.rs` | 39509 | `d65965c8a3f155254414a2daae98a0823ec29a016e7d0126773c68a857f79d87` | `100644` |
...
| `crates/trpg-api/tests/player_action_http_integration.rs` | 45925 | `97d58edebd28eec7fe0592b7908bd97c6faccc485d33549298280a466f63fc67` | `100644` |
...
| `crates/trpg-contracts/src/service.rs` | 15353 | `d88e4e751bcbe14a4aed21dcbb4f1cb50419548515cc2a0f42658af28ab372d6` | `100644` |
...
| `crates/trpg-contracts/test-support/src/lib.rs` | 26772 | `cdefaa3c0db80793b8c990429439c31cf67f96cb12cb49cf46389258271ada46` | `100644` |
...
| `crates/trpg-data-eventing/src/cache_redis_impl.rs` | 29198 | `b1bc44b5a8f3d3c08ef7093fd7039e02b1f9392f4f4ada3ed5c24c8450c9fc09` | `100644` |
...
| `crates/trpg-data-eventing/src/event_bus_nats_impl.rs` | 43890 | `f3c958e77c36a67b01ba38df1dff2e0ae5b3bd54973e8ea47942a6849c3cfb66` | `100644` |
...
| `crates/trpg-data-eventing/src/event_store_sqlx_outbox_projection.rs` | 194768 | `500271cc79064ab041ae049c126548dc55670918a48aecd055a557eac33b2f22` | `100644` |
| `crates/trpg-data-eventing/src/lib.rs` | 27163 | `f2ff55a977094ed77e0d3020a8ab2265513d44e64e6a57011d67d0df1a635a1c` | `100644` |
...
| `crates/trpg-data-eventing/src/outbox_projection_workers.rs` | 58598 | `e63fe0da830d787dd703993080fd58a897b2922cadac2f52775a96019b4a76e4` | `100644` |
...
| `crates/trpg-data-eventing/src/persistence_postgresql.rs` | 594291 | `861db71ca82638f557bd19ab2ad6baf187af23cf33837f8e217b62a9d29cca85` | `100644` |
...
| `crates/trpg-data-eventing/tests/batch_024_data_eventing_contract_tests.rs` | 16033 | `fa63d109d0818acb48d1b6daac8c1ac016988b6280a3d51228a8b670ccae1d88` | `100644` |
...
| `crates/trpg-data-eventing/tests/core_domain_schema_integration.rs` | 225223 | `9b11a50a00ad8960defd19143c04e48630d167a25fed93fd1fa0ba0596fdf73b` | `100644` |
...
| `crates/trpg-data-eventing/tests/jetstream_redis_integration.rs` | 25228 | `13e7c830924d94cba919bf7885b305e070d10bcb0491bbcd3da49731d1f80792` | `100644` |
| `crates/trpg-data-eventing/tests/migration_upgrade.rs` | 61432 | `26ef16d912a2b89cf41cb9482ed51fce90ca030a5bed2f5ede22a06844c402f0` | `100644` |
| `crates/trpg-data-eventing/tests/postgres_event_store_integration.rs` | 14985 | `ff2b5af9b1b6e471f50ec01297b1ca6edf97684eb17736a434c20c2fad0d156b` | `100644` |
...
| `crates/trpg-data-eventing/tests/projection_resume.rs` | 20611 | `9223d9a2b1bfcb3d848c974ab6800a25293eb21d892eb815472676e0e2ff37a8` | `100644` |
| `crates/trpg-data-eventing/tests/rag_snapshot_contract_tests.rs` | 27726 | `92c1da4a1840341cb64a1426836cee270d8a14769c4be462aab30848eaefc794` | `100644` |
...
| `crates/trpg-domain-core/src/canonical_gameplay_state.rs` | 72213 | `301f7a8ab391d8b237c17357cebdb45a4f1e2c0708a9cba106fac031f6dc3a3f` | `100644` |
...
| `crates/trpg-domain-core/src/domain_entities_value_objects.rs` | 31745 | `16bdbc5bc78d0581180a45e7790109964de51dfe20baabe8d04d496127a65edb` | `100644` |
...
| `crates/trpg-domain-core/src/visibility_fact_provenance.rs` | 18438 | `f50731aa2f438978f3015189dc2f6f7a960ef428d8c2f4cf3037b6879610f9b3` | `100644` |
...
| `crates/trpg-extension-sdk/src/plugin_host.rs` | 15870 | `6c7bef5c12c74f94ec5f1b2e9afef3dd9447f4916741664e8e1186a2fc46777b` | `100644` |
| `crates/trpg-extension-sdk/src/plugin_sdk.rs` | 6171 | `bc093ab285a5dfad8d50ca8b3d30595cdf79adaf9674f1ac323122666a4d71ce` | `100644` |
| `crates/trpg-extension-sdk/src/readme.rs` | 21632 | `fbd7089f60f4b2454a2ccab1c939746789fbe4db705f71ced2112abad4c3f74a` | `100644` |
...
| `crates/trpg-extension-sdk/tests/plugin_host_runtime.rs` | 16551 | `48c1d6087d5c86dd709b10690ac5f0bcc0a3d24c1cf86d56db86283257dfc979` | `100644` |
...
| `crates/trpg-identity/src/lib.rs` | 126701 | `88903215809ff4c47223c64c24e6b79021451e76de85d639ad64413944666cbb` | `100644` |
...
| `crates/trpg-ops/src/backup_restore_runbook.rs` | 15232 | `34c6f8683381f217ff816e96570c990cbef6f1dc90be16f1ddc27acec9836e49` | `100644` |
...
| `crates/trpg-ops/src/readme.rs` | 13103 | `d7c50c3e4805e0aaf0fb1d87cf9d49d5992dcb79b6e2d9776854adab0cebc861` | `100644` |
...
| `crates/trpg-platform/src/security_privacy_copyright.rs` | 17285 | `4c9616520d466a8f843ad08d91995dd00bc59dd6d6c6186cc2715db52e88a13d` | `100644` |
...
| `crates/trpg-platform/tests/s09_fixture_acceptance_contract_tests.rs` | 11888 | `cec81aacc49ba5865754fb79a8debca447172d8732d5855528e67cf215fd666d` | `100644` |
...
| `crates/trpg-ruleset-coc7/src/character_combat_san_chase.rs` | 16411 | `4999eae40edd0a0095c03ff426f9b7ba1bad735ed56cd4893bc61bbfa2af8180` | `100644` |
| `crates/trpg-ruleset-coc7/src/chase_state_machine.rs` | 18132 | `58a1b8bd7dbb77f2b79b5ed68bd3ef704f58fa60a997079576cb81fa4c82f41d` | `100644` |
...
| `crates/trpg-ruleset-coc7/src/combat_state_machine.rs` | 48406 | `5716150b29ba4c6490213fd76946bb9a1fa008c6dfc97c03c5d3a61a2e2192f1` | `100644` |
...
| `crates/trpg-ruleset-coc7/tests/combat_condition_sequence.rs` | 25644 | `01ce10de482fcaadb0d39b7fe91db29b80da775f4528a8c2054858836d65f13d` | `100644` |
...
| `crates/trpg-runtime/src/durable_workflow.rs` | 21732 | `22cba5a86b8475429126656daacada640b87d280f63a184e63c725a96cf94f37` | `100644` |
...
| `crates/trpg-runtime/src/runtime_state_machines.rs` | 48846 | `728cda87fb6713a39217340286caca345bcc587f411d28c2b02f392bc4f902bc` | `100644` |
...
| `crates/trpg-runtime/src/session_runtime.rs` | 29072 | `ab1b68961ce0cb5d0a856f21f610e337ea391665b8b040ade8a82ea4c06e7440` | `100644` |
...
| `crates/trpg-runtime/tests/batch_012_runtime_contract_tests.rs` | 25085 | `f5e038ab64a0d570df591034154ede7a18c0ff4d1ee39252c209dcddd334776c` | `100644` |
...
| `crates/trpg-runtime/tests/human_confirmation_gate.rs` | 16298 | `c92eb0bf0d4681f16a418a57761f82baa6309757447713120c1c5c886385b351` | `100644` |
...
| `crates/trpg-runtime/tests/session_scene_state_machine.rs` | 19523 | `0ae655b0fd36a0e361c20bad7431379b706201de4d0b19594688843e877be920` | `100644` |
...
| `crates/trpg-security-governance/src/cloud_egress.rs` | 29911 | `1e9be81c2b482b2f1b0c93c7b7b677d1f85e260fa6c92027619fa69da5ab8d06` | `100644` |
...
| `crates/trpg-security-governance/src/formal_commit_audit.rs` | 15815 | `756687993026b4ac3caf38bc0499c50799c8e81eee462d7451af0efee116209f` | `100644` |
| `crates/trpg-security-governance/src/lib.rs` | 32844 | `0a0eba951734c690a8d4640f35c959db41fd313b5be826ef97d14727cb77c04c` | `100644` |
...
| `crates/trpg-security-governance/src/secret.rs` | 22638 | `31e2e2f20a991645da542637284befec371d2048c5d3cbab6b4e579311938ab6` | `100644` |
| `crates/trpg-security-governance/src/security_privacy.rs` | 122079 | `c21d20ea92824df8c46a733a895774cb8625b782a02aea25d9cf4069cf78bb1d` | `100644` |
...
| `crates/trpg-security-governance/src/tamper_evident_audit.rs` | 19331 | `a4861b95f0e8acc249fddde17d253ecfb5076def000a4b71c70f1186a22c0aa5` | `100644` |
...
| `crates/trpg-security-governance/tests/batch_035_security_governance_contract_tests.rs` | 21581 | `dbed877320a35b00c5514b63853a6b3e274dc0661dfc092eb18a89ed58a92910` | `100644` |
...
| `crates/trpg-security-governance/tests/data_deletion_e2e.rs` | 43906 | `380d51122ce1d12fdaf843ed321dcdd1b58b81a27597b5d5cd222d2c2bb1a23b` | `100644` |
...
| `crates/trpg-security-governance/tests/policy_fail_closed.rs` | 23723 | `2796fdd17c8945098f348b4a23d9bf701ed060d10f34217c8e07857c19c2dc65` | `100644` |
...
| `crates/trpg-shared-kernel/src/shared_kernel.rs` | 80774 | `000afe323271ab71cbc01d0dc56564535eacb42f886e01006dec700a12915b6f` | `100644` |
...
| `crates/trpg-testing/tests/tutorial_complete_e2e.rs` | 103027 | `9d40d915759e9344dbed4ad522d2fdc0d1b0376b4f64dd376fe16636807b6778` | `100644` |
...
| `docs/audit/p08/P08_FINAL_STATUS.md` | 44304 | `e034661cf6bb3e7ceefc2a73d0c8d2fa28aa4e0c9261a1b15830a3f0e95297df` | `100644` |
| `docs/audit/p08/P08_FINDINGS_TRACEABILITY.md` | 34319 | `d061a4b3cdd580ed44619e896381d182859ef1cdb11d2aac8c5e3a8f79ee5dda` | `100644` |
| `docs/audit/p08/P08_TEST_RESULTS.md` | 51343 | `2ff1f8f26a6e0e62879a9d619940b03cd444fba7f909a79f2bfa3efa35d9b0fb` | `100644` |
| `docs/audit/p08/P08_THIRD_PARTY_REVIEW.md` | 49346 | `4de260e0a3ec397c97468833058926a6ea43e9c99a023b4f17451641f17562cc` | `100644` |
...
| `scripts/ci/assert-schema.sql` | 117121 | `129b9bcf21434e0bf3f55a5c22ec90e31f689b7c0e0755b316dfd13ce32a6fe4` | `100644` |
...
| `scripts/ci/production-security-smoke.sh` | 26385 | `62290739408856d4a39e53ef2c23370a4fedd11f63be969923a614bb6e939aa3` | `100755` |
...
| `scripts/ci/test-all.sh` | 9744 | `be3027b7784d68d7d21dd962a99032a08f43b5e3fc31e05ee3a32b1f6c453e0c` | `100755` |
...
| `scripts/ci/test_repo_truth.py` | 31155 | `66f4b13f87bb3641e8b0a33e4d83a4ada33391164d3336b7b64f3d8d85fce9c1` | `100644` |
| `scripts/ci/validate_workflows.py` | 6981 | `fc6e470f0ba195b2b792240a3337f90898eb400563d8405fd48baa5d268770ba` | `100644` |
| `scripts/ci/verify_compose_security.py` | 18544 | `c92d7844b0f3c81589d979a67d300187b33996433263e8dd1a87d82b4ac79acb` | `100755` |
