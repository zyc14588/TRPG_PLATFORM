...
use trpg_domain_core::character_combat_san_chase_impl::{
...
#[test]
fn character_combat_san_chase_impl_rejects_authority_violation_without_event() {
    let contract =
...
#[test]
fn character_combat_san_chase_impl_preserves_visibility_and_provenance_on_replay() {
    let contract =
