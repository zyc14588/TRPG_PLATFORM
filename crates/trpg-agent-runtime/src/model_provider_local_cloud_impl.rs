...
use crate::local_model_certification::{
    ensure_ai_keeper_provider_config, LocalModelCertificate, LocalModelCertificationAuthority,
};
use crate::model_provider::{
    evaluate_cloud_fallback, provider_boundary_snapshot, resolve_provider_runtime_sha256,
    validate_provider_config, CloudContextFact, CloudEgressAuthorization, ExecutableModelProvider,
...
pub fn evaluate_provider_route_for_ai_keeper(
    ...
    ensure_ai_keeper_provider_config(certification_authority, local_model_certificate, source)?;
