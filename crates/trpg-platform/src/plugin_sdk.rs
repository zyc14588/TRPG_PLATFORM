...
pub const PLUGIN_TOOL_GRANT_REGISTERED_EVENT: &str = "platform.plugin_sdk.tool_grant_registered";
pub const PLUGIN_SDK_METRIC_MODULE: &str = "plugin_sdk";
pub const PLUGIN_SDK_REQUIRED_METRICS: &[&str] = &[
    "trpg_command_total",
