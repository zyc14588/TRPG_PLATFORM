...
pub const PLATFORM_AUTHORIZATION_GRANTED_EVENT: &str =
    "platform.policy_authz_impl.authorization_granted";
pub const POLICY_AUTHZ_IMPL_METRIC_MODULE: &str = "policy_authz_impl";
pub const POLICY_AUTHZ_IMPL_REQUIRED_METRICS: &[&str] = &[
    "trpg_command_total",
...
impl PolicyAuthzService {
    pub fn evaluate_platform_authorization(
        ...
        if command.payload.decision == AuthorizationDecision::Deny {
