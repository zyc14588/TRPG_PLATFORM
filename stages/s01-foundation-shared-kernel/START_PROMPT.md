# S01 START_PROMPT — Rust Workspace 与 shared kernel 基座
...
你是 Codex，正在启动 `S01 — Rust Workspace 与 shared kernel 基座`。
...
4. `S01` 阶段 README
5. 相关分类：`docs/codex/01-foundation`
6. 相关 batch：BATCH-003-01-foundation, BATCH-004-01-foundation, BATCH-005-01-foundation, BATCH-006-01-foundation
7. 相关 per-file prompts：`codex-prompts/01-foundation/**`
