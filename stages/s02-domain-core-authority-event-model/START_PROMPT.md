# S02 START_PROMPT — Domain Core：Authority、Campaign、Decision 与事件模型
...
你是 Codex，正在启动 `S02 — Domain Core：Authority、Campaign、Decision 与事件模型`。
...
4. `S02` 阶段 README
5. 相关分类：`docs/codex/02-domain-core`
6. 相关 batch：BATCH-007-02-domain-core, BATCH-008-02-domain-core, BATCH-009-02-domain-core, BATCH-010-02-domain-core, BATCH-011-02-domain-core
7. 相关 per-file prompts：`codex-prompts/02-domain-core/**`
