# S05 START_PROMPT — COC7 Ruleset：角色、骰子、检定、SAN、战斗、追逐、场景结构
...
你是 Codex，正在启动 `S05 — COC7 Ruleset：角色、骰子、检定、SAN、战斗、追逐、场景结构`。
...
4. `S05` 阶段 README
5. 相关分类：`docs/codex/05-ruleset-coc7`
6. 相关 batch：BATCH-021-05-ruleset-coc7, BATCH-022-05-ruleset-coc7, BATCH-023-05-ruleset-coc7
7. 相关 per-file prompts：`codex-prompts/05-ruleset-coc7/**`
