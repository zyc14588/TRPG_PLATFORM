# S06 START_PROMPT — Runtime Orchestration：Session、Workflow、Pending Decision、Decision Commit Pipeline
...
你是 Codex，正在启动 `S06 — Runtime Orchestration：Session、Workflow、Pending Decision、Decision Commit Pipeline`。
...
4. `S06` 阶段 README
5. 相关分类：`docs/codex/03-runtime-orchestration`
6. 相关 batch：BATCH-012-03-runtime-orchestration, BATCH-013-03-runtime-orchestration, BATCH-014-03-runtime-orchestration, BATCH-015-03-runtime-orchestration, BATCH-016-03-runtime-orchestration
7. 相关 per-file prompts：`codex-prompts/03-runtime-orchestration/**`
