# S06 REPAIR_PROMPT — Runtime Orchestration：Session、Workflow、Pending Decision、Decision Commit Pipeline
...
你是 Codex 修复代理。当前阶段 `S06 — Runtime Orchestration：Session、Workflow、Pending Decision、Decision Commit Pipeline` 出现失败。
