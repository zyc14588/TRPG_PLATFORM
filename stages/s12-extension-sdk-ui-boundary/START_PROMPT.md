# S12 START_PROMPT — Extension SDK 与分层 UI 边界
...
你是 Codex，正在启动 `S12 — Extension SDK 与分层 UI 边界`。
...
4. `S12` 阶段 README
5. 相关分类：`docs/codex/12-extension-sdk`
6. 相关 batch：BATCH-044-12-extension-sdk, BATCH-045-12-extension-sdk
7. 相关 per-file prompts：`codex-prompts/12-extension-sdk/**`
