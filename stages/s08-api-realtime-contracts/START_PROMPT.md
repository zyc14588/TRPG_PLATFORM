# S08 START_PROMPT — API / Realtime：REST、OpenAPI、WebSocket、NATS Contract、服务二进制
...
你是 Codex，正在启动 `S08 — API / Realtime：REST、OpenAPI、WebSocket、NATS Contract、服务二进制`。
...
4. `S08` 阶段 README
5. 相关分类：`docs/codex/07-api-realtime-contracts`
6. 相关 batch：BATCH-029-07-api-realtime-contracts, BATCH-030-07-api-realtime-contracts
7. 相关 per-file prompts：`codex-prompts/07-api-realtime-contracts/**`
