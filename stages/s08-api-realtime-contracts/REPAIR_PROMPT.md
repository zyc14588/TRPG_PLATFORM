# S08 REPAIR_PROMPT — API / Realtime：REST、OpenAPI、WebSocket、NATS Contract、服务二进制
...
你是 Codex 修复代理。当前阶段 `S08 — API / Realtime：REST、OpenAPI、WebSocket、NATS Contract、服务二进制` 出现失败。
