# S08 ACCEPTANCE_PROMPT — API / Realtime：REST、OpenAPI、WebSocket、NATS Contract、服务二进制
...
你是 Codex 验收代理。请验收 `S08 — API / Realtime：REST、OpenAPI、WebSocket、NATS Contract、服务二进制` 的实现。
