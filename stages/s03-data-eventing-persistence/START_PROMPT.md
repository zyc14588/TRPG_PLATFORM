# S03 START_PROMPT — Data/Eventing：PostgreSQL、Event Store、Outbox、Projection、RAG Snapshot
...
你是 Codex，正在启动 `S03 — Data/Eventing：PostgreSQL、Event Store、Outbox、Projection、RAG Snapshot`。
...
4. `S03` 阶段 README
5. 相关分类：`docs/codex/06-data-eventing`
6. 相关 batch：BATCH-024-06-data-eventing, BATCH-025-06-data-eventing, BATCH-026-06-data-eventing, BATCH-027-06-data-eventing, BATCH-028-06-data-eventing
7. 相关 per-file prompts：`codex-prompts/06-data-eventing/**`
