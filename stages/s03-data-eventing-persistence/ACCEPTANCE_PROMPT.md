# S03 ACCEPTANCE_PROMPT — Data/Eventing：PostgreSQL、Event Store、Outbox、Projection、RAG Snapshot
...
你是 Codex 验收代理。请验收 `S03 — Data/Eventing：PostgreSQL、Event Store、Outbox、Projection、RAG Snapshot` 的实现。
