# S11 REPAIR_PROMPT — Testing Quality：Tutorial/Golden Scenario、Contract、Leakage、Model Certification CI
...
你是 Codex 修复代理。当前阶段 `S11 — Testing Quality：Tutorial/Golden Scenario、Contract、Leakage、Model Certification CI` 出现失败。
