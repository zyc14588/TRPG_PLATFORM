# S11 ACCEPTANCE_PROMPT — Testing Quality：Tutorial/Golden Scenario、Contract、Leakage、Model Certification CI
...
你是 Codex 验收代理。请验收 `S11 — Testing Quality：Tutorial/Golden Scenario、Contract、Leakage、Model Certification CI` 的实现。
