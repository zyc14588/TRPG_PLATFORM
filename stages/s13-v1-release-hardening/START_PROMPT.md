# S13 START_PROMPT — V1 Release Hardening 与总验收
...
你是 Codex，正在启动 `S13 — V1 Release Hardening 与总验收`。
...
5. 相关分类：`docs/codex/**`
6. 相关 batch：ALL
7. 相关 per-file prompts：请依据 `codex-active-normalized/CURRENT_NORMALIZED_PROMPT_EXECUTION_MAP.md` 读取本阶段对应的 `codex-prompts/<category>/P####.md`。
