# S04 START_PROMPT — Security Governance：OpenFGA/OPA、权限、隐私、版权与审计
...
你是 Codex，正在启动 `S04 — Security Governance：OpenFGA/OPA、权限、隐私、版权与审计`。
...
4. `S04` 阶段 README
5. 相关分类：`docs/codex/09-security-governance`
6. 相关 batch：BATCH-035-09-security-governance, BATCH-036-09-security-governance, BATCH-037-09-security-governance
7. 相关 per-file prompts：`codex-prompts/09-security-governance/**`
