...
| `Cargo.lock` | 93841 | `50f66ba1a4d1539d2a866d0491e6820b5a1b815775dff6795d51e61c795160ee` | `100644` |
...
| `apps/api-server/Cargo.toml` | 891 | `dfac0400cb5730a7121ae6acc644ac22b6c84947bbb05cf04c6f445c5cb06915` | `100644` |
| `apps/api-server/src/lib.rs` | 43702 | `d01b9e9da016f3214cb99bb04c6d2836bc8fbee11b638a226f4b893b96e1cda1` | `100644` |
| `apps/api-server/src/main.rs` | 15725 | `ec76de751ed8ddc394cc38ec013e5e34c507f40cf1210111e3735e0dcc14313f` | `100644` |
...
| `apps/api-server/src/production_custody_tests.rs` | 16685 | `23d7e23be6e43f6fd0835969455720d206260c8bbfa4809f577fd984b2fa3105` | `100644` |
...
| `apps/api-server/tests/canonical_replay_integration.rs` | 12877 | `f8bae2b0fab4e5c79eccd203eadff84c1667f822a9c1d5dba4c65e73e1bf6ee4` | `100644` |
...
| `crates/trpg-agent-runtime/src/agent_pack_sdk.rs` | 1546 | `7dbb8a627cfd36aa59bcb3821a7cb329a999d0f43d35ff14492ad2d4b2eedd46` | `100644` |
| `crates/trpg-agent-runtime/src/agent_runtime.rs` | 29925 | `9d9d6341216abb66f056dc5e175cb4a840bd9fb0ec35b11b2b09daf78f1b9f59` | `100644` |
...
| `crates/trpg-agent-runtime/src/lib.rs` | 2216 | `190a5f341e5c25e20933827f93557acd1bda9c0ae780d32b1801074a4794c74d` | `100644` |
...
| `crates/trpg-agent-runtime/src/plugin_ruleset_agent_pack_sdk.rs` | 1285 | `5d6f5349afd61d9e352e82dcc619332b244d0a0bac09cfed4a9ed06094b56291` | `100644` |
...
| `crates/trpg-agent-runtime/tests/agent_pack_sdk_contract_tests.rs` | 2162 | `6139cdb4eab43f47d8fcd76d0883ecf447fee8890ed7553347736165b8879d53` | `100644` |
...
| `crates/trpg-agent-runtime/tests/ai_agent_contract_tests.rs` | 9428 | `52f6adfc69c68b6b8fcf3910b75932d273b206664e2c0c594470dcc899ad30fc` | `100644` |
| `crates/trpg-agent-runtime/tests/batch_017_agent_runtime_contract_tests.rs` | 28493 | `8a047db0584ddaabaf7a3ad30f436c753ea116c6ed6ae31e554c9c46e4b3b278` | `100644` |
...
| `crates/trpg-api/Cargo.toml` | 357 | `078b71ff6aee04d88aed424cce3191f5a8592454d49441a308abfee1300137a0` | `100644` |
...
| `crates/trpg-api/src/api_contracts.rs` | 194 | `2e04680ad628b56214079612a51ca40b70b8441be197d364a29df0dacd8bc5d7` | `100644` |
...
| `crates/trpg-data-eventing/Cargo.toml` | 1242 | `255e47537873b811b5d1763c2ffb681534e4acebdcb41d5edb12111c6502c33f` | `100644` |
...
| `crates/trpg-data-eventing/src/event_store_sqlx_outbox_projection.rs` | 166792 | `19acb52c272a0ad415a5979d98f95fd9e1bb8f3c88f35fd5d3832a211d96b4d4` | `100644` |
...
| `crates/trpg-data-eventing/src/persistence_postgresql.rs` | 776 | `9061c39ebf4f558102900696109bfa91132520541dfd1a41a6894e217d9a7120` | `100644` |
...
| `crates/trpg-data-eventing/tests/canonical_commit_postgres.rs` | 30600 | `d958e0a8d7ff2b40cc9772255c8c4f2ecbbcd3a2d1fea4216655cf0e25948fc0` | `100644` |
...
| `crates/trpg-data-eventing/tests/jetstream_redis_integration.rs` | 24991 | `49f0558c6e9b293bd4ad3f3eb41e13ff116ab9499c3d163f8504883e5ab0c809` | `100644` |
| `crates/trpg-data-eventing/tests/migration_upgrade.rs` | 59144 | `a2bf538305df25aaeabdd9ae37caa13701bbdc9e011ea6158e659f5209a1c2f8` | `100644` |
...
| `crates/trpg-data-eventing/tests/support/mod.rs` | 5323 | `c50bdf5c1ec0ed5656571c3a16596a7896b5b6740b254e605595a5b951fb23a3` | `100644` |
...
| `crates/trpg-domain-core/src/domain_entities_value_objects.rs` | 1980 | `fb1cf3df45826768170edffa28bda5a62b49bfcbfd00216a868de9ba430d6ab8` | `100644` |
...
| `crates/trpg-domain-core/tests/authority_owner_integration.rs` | 5168 | `02aad56e3a88aab448e097ad2ca86c995b79965900fb551c8e49bba6e0ced0b7` | `100644` |
...
| `crates/trpg-ruleset-coc7/Cargo.toml` | 426 | `11d3a18fcca07b61508395e627dd28ac9cd5d90ac296974a97b0788e299a3975` | `100644` |
| `crates/trpg-ruleset-coc7/src/character_combat_san_chase.rs` | 2976 | `ad1a2cb55deaef855ad5739f80b32c559933c24d45fce2828f8b11120f6c7323` | `100644` |
...
| `crates/trpg-ruleset-coc7/src/san.rs` | 1396 | `f085b2f1efcec2c7b310a961bea50040990ff20c97d44b79c23e90fa24c7a097` | `100644` |
| `crates/trpg-ruleset-coc7/src/sanity_madness_state_machine.rs` | 1793 | `26323cb5283773a93bb56a9c799ac40b4a0441ac958c1ecf44025a7f7e9bb674` | `100644` |
...
| `crates/trpg-ruleset-coc7/tests/s05_fixture_acceptance_contract_tests.rs` | 8491 | `f76fdb7688e39e7a8e5d0adfd009e6ddb0c5324fd3ee2a2b52eba5edcde0332b` | `100644` |
...
| `crates/trpg-runtime/Cargo.toml` | 757 | `2f78364fb5efd9d20f948975b30b2f0df2d96e6efa83e82d8df926c4d597a5ee` | `100644` |
...
| `crates/trpg-runtime/src/lib.rs` | 1226 | `d28f9d37f1d99c5481fd7a1afc239970a0a5b61328dab309b31e428715690d3b` | `100644` |
...
| `crates/trpg-runtime/src/runtime_state_machines.rs` | 43514 | `513fab338540665b81fbdf63c86a98465b952268c43de0eaf4aef76caba88552` | `100644` |
...
| `crates/trpg-runtime/src/session_runtime.rs` | 662 | `663c6df536206f1fce82e065f25e3dca2a66a57fee7572579bdd9a0fbe39d4a6` | `100644` |
...
| `crates/trpg-runtime/tests/batch_012_runtime_contract_tests.rs` | 22533 | `6fd767f12f476393b7477e10e9eab11f6df68408c7c21b4b2051d2d84c92c796` | `100644` |
...
| `crates/trpg-runtime/tests/capability_layer_impl_contract_tests.rs` | 5729 | `12d763394a550751ba307a7a370342786aafd5f2d7f59f77b000744499df2e57` | `100644` |
| `crates/trpg-runtime/tests/common/mod.rs` | 1597 | `2f54031648e96704112839830e343b679988105cf98775018dfbd774b1f47093` | `100644` |
...
| `crates/trpg-runtime/tests/human_confirmation_gate.rs` | 15701 | `d48c4f14486ca2f18aafc8233985c17d209766283c249801fa8e92e4a88302f8` | `100644` |
| `crates/trpg-runtime/tests/pending_decision_impl_contract_tests.rs` | 5527 | `407dfc73e07cfcadb043a86b6a967296a5043d0dfab490e6506e7becb413eff6` | `100644` |
...
| `crates/trpg-runtime/tests/realtime_room_sync_impl_contract_tests.rs` | 5508 | `ce60652026f1b6ba0e4c98ddb48e84363c5b6e18c6b2761769ca7a1049af331e` | `100644` |
| `crates/trpg-runtime/tests/runtime_contract_tests.rs` | 5864 | `3760fdc959616c3a275234e74b208bccd3bf24cb46ccf7ddcda9e484e0d0a332` | `100644` |
| `crates/trpg-runtime/tests/runtime_pending_decision.rs` | 1389 | `db357e5c8eebaff8392f7f0fdb779e922efa5ccdb63f11ea01276e8d758f19a3` | `100644` |
| `crates/trpg-runtime/tests/runtime_workflow_state_machines_contract_tests.rs` | 6190 | `35bc06a28f276fda0281aff66bbca027e6c2570a998c1c2de393bde088803337` | `100644` |
...
| `crates/trpg-runtime/tests/saga_transaction_impl_contract_tests.rs` | 6242 | `d0fcdc0bbae3ba993d3d69b6e83bd9966519fc855a06d27890a4b3b38e0a8840` | `100644` |
| `crates/trpg-runtime/tests/scheduler_service_impl_contract_tests.rs` | 6485 | `392a1aab8cae7b48a5068b2143b777b9e21159d71e5a9b96ed089f39051fc4f6` | `100644` |
| `crates/trpg-runtime/tests/session_runtime_impl_contract_tests.rs` | 6123 | `482770e3fa9ce752bb7b8fb3ed818fcb4fed56d02a9442bedd580609c7b1e374` | `100644` |
| `crates/trpg-runtime/tests/workflow_engine_contract.rs` | 1298 | `71bc0d627978c21640cc3ea0472e7eca9828ccc07c7caf9f27ed6c22c9eff20c` | `100644` |
| `crates/trpg-runtime/tests/workflow_engine_impl_contract_tests.rs` | 6319 | `690f7e2600bcb5ad351bb1320a66488607d05fc3f576b94e622adb35784604da` | `100644` |
...
| `crates/trpg-security-governance/tests/data_deletion_e2e.rs` | 43668 | `d4486638c9e3a7c05a15becb514957c2a3c05ad61e54818da5e5234e051fe229` | `100644` |
...
| `crates/trpg-shared-kernel/src/shared_kernel.rs` | 79704 | `f469036b40fbd0fe134fd93d3a15a59d8c00d906a56da67e6a4203f29dc1550e` | `100644` |
...
| `crates/trpg-testing/Cargo.toml` | 560 | `9693ba034d6681cb9002b5dc019d9d1d6b8d8db89ab9b5e9f1892607bd6078da` | `100644` |
...
| `scripts/ci/assert-schema.sql` | 77356 | `09b411a3865d08c5a8ec3c11445c78289d256c4ed5fe9212a2bda7f58acf9062` | `100644` |
