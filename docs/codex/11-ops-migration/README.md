> [v2.21 自包含来源清理标记]
> 原始路径：`docs/codex/11-ops-migration/README.md`
...
# 11-ops-migration — Codex 模块施工目录

范围：Backup / restore / migration / incident response / release
默认 crate：`trpg-ops`
默认 module prefix：`ops_migration`
Per-file prompts：43

## 模块关键要求

备份、恢复、迁移、rollback 必须保护 Event Store 正史完整性。
...
- per-file prompts：`codex-prompts/11-ops-migration/`
