# Source Processing Record - source_processing_record_docs_architecture_cargo_workspace

- Prompt ID: CODEX-0193-01-FOUNDATION-0f9b6b9191
- Batch: BATCH-005-01-foundation
- Prompt file: codex-prompts/01-foundation/P0056.md
- Source file: docs/implementation/90-traceability/per-file-code-ready/01-foundation/docs-implementation-90-traceability-source-processing-01-foundation-docs-architecture-cargo-workspace-processe-22e40e3a5a.v5-code-ready.md (provenance only)
- Source SHA256: db50fa07e77cd8a7b3606d41bede35640a52f277d272251f0590321542157294 (provenance only)
- Current-safe module: shared_kernel::source_processing_record_docs_architecture_cargo_workspace
- Current-safe output: docs/codex/01-foundation/source_processing_record_docs_architecture_cargo_workspace.md
