> [v2.21 自包含来源清理标记]
> 原始路径：`docs/codex/09-security-governance/README.md`
...
# 09-security-governance — Codex 模块施工目录

范围：OpenFGA / OPA / audit / privacy / visibility enforcement
默认 crate：`trpg-security-governance`
默认 module prefix：`security_governance`
Per-file prompts：54

## 模块关键要求

OpenFGA/OPA/audit/retention 是强制门禁，不能降级为日志注释。
...
- per-file prompts：`codex-prompts/09-security-governance/`
