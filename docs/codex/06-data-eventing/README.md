> [v2.21 自包含来源清理标记]
> 原始路径：`docs/codex/06-data-eventing/README.md`
...
# 06-data-eventing — Codex 模块施工目录

范围：Event Store / SQLx / Outbox / NATS / Projection
默认 crate：`trpg-data-eventing`
默认 module prefix：`data_eventing`
Per-file prompts：107

## 模块关键要求

Event Store 是正史，NATS、projection、cache 都是派生层。
...
- per-file prompts：`codex-prompts/06-data-eventing/`
