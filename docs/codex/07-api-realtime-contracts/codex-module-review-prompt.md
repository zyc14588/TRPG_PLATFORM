> [v2.21 自包含来源清理标记]
> 原始路径：`docs/codex/07-api-realtime-contracts/codex-module-review-prompt.md`
...
# 07-api-realtime-contracts — Codex 模块评审 / 修复提示词

```text
审查 `07-api-realtime-contracts` 模块变更，重点寻找：
