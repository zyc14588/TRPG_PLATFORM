> [v2.21 自包含来源清理标记]
> 原始路径：`docs/codex/07-api-realtime-contracts/README.md`
...
# 07-api-realtime-contracts — Codex 模块施工目录

范围：Axum API / OpenAPI / WebSocket / realtime contracts
默认 crate：`trpg-api`
默认 module prefix：`api_realtime`
Per-file prompts：48
...
- per-file prompts：`codex-prompts/07-api-realtime-contracts/`
