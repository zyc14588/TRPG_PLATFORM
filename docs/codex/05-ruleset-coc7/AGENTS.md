> [v2.21 自包含来源清理标记]
> 原始路径：`docs/codex/05-ruleset-coc7/AGENTS.md`
...
# AGENTS.md — 05-ruleset-coc7 Codex 模块规则

本文件是 `05-ruleset-coc7` 模块的局部 Codex 指令。执行该模块相关代码前，先读取仓库根 `AGENTS.md`，再读取本文件。

## 模块范围

CoC7 ruleset / dice / combat / sanity / chase
