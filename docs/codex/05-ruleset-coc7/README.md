> [v2.21 自包含来源清理标记]
> 原始路径：`docs/codex/05-ruleset-coc7/README.md`
...
# 05-ruleset-coc7 — Codex 模块施工目录

范围：CoC7 ruleset / dice / combat / sanity / chase
默认 crate：`trpg-ruleset-coc7`
默认 module prefix：`ruleset_coc7`
Per-file prompts：65

## 模块关键要求

规则实现必须可回放、可测试、可解释，并隔离 keeper-only 事实。
...
- per-file prompts：`codex-prompts/05-ruleset-coc7/`
