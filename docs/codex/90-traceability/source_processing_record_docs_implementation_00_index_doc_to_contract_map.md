# source processing record docs implementation 00 index doc to contract map
...
- Current output: `docs/codex/90-traceability/source_processing_record_docs_implementation_00_index_doc_to_contract_map.md`

| Prompt ID | Prompt file | Current crate | Current module | Source file | Source SHA256 |
|---|---|---|---|---|---|
| `CODEX-1020-90-TRACEABILITY-910724dc09` | `codex-prompts/90-traceability/P0054.md` | `trpg-docs-governance` | `traceability::source_processing_record_docs_implementation_00_index_doc_to_contract_map` | `docs/implementation/90-traceability/per-file-code-ready/90-traceability/docs-implementation-90-traceability-source-processing-00-index-docs-implementation-00-index-doc-to-contract-ma-ed6f514221.v5-code-ready.md` | `8c9526c88cbd92d7dabc35996b8df80d91ec4e214622eece3b3d0a9598f08296` |
...
- `CODEX-1020-90-TRACEABILITY-910724dc09`: implemented as docs-only traceability.
