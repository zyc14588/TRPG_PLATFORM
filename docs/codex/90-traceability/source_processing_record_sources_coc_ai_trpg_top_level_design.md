# source processing record sources coc ai trpg top level design
...
- Current output: `docs/codex/90-traceability/source_processing_record_sources_coc_ai_trpg_top_level_design.md`

| Prompt ID | Prompt file | Current crate | Current module | Source file | Source SHA256 |
|---|---|---|---|---|---|
| `CODEX-1038-90-TRACEABILITY-edeb3e648d` | `codex-prompts/90-traceability/P0071.md` | `trpg-docs-governance` | `traceability::source_processing_record_sources_coc_ai_trpg_top_level_design` | `docs/implementation/90-traceability/per-file-code-ready/90-traceability/docs-implementation-90-traceability-source-processing-90-traceability-sources-coc-ai-trpg-top-level-design-pro-e045d3ea94.v5-code-ready.md` | `4e1b1931fcef1895cdb4b095328924a2a06599dbed44d16885703fa38d0bfa64` |
...
- `CODEX-1038-90-TRACEABILITY-edeb3e648d`: implemented as docs-only traceability.
