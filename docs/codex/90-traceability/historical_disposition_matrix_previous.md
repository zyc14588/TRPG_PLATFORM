# historical disposition matrix previous
...
- Current output: docs/codex/90-traceability/historical_disposition_matrix_previous.md

| Prompt ID | Prompt file | Current crate | Current module | Source file | Source SHA256 |
|---|---|---|---|---|---|
| CODEX-0112-90-TRACEABILITY-55db7c975b | codex-prompts/90-traceability/P0106.md | trpg-docs-governance | traceability::historical_disposition_matrix_previous_provenance | docs/implementation/90-traceability/previous-disposition-matrix-v5.md | 9a180be774ec08d891c3d9800df86eed9e4436622de3870d102911b72913ed9d |
...
- CODEX-0112-90-TRACEABILITY-55db7c975b: implemented as docs-only traceability; test responsibility is covered by B046 prompt coverage, current-safe output, docs-only boundary, and provenance checks in evidence/batches/BATCH-046/test-output.txt.
