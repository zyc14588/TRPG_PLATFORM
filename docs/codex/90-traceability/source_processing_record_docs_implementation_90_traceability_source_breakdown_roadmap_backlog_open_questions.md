# source processing record docs implementation 90 traceability source breakdown roadmap backlog open questions
...
- Current output: `docs/codex/90-traceability/source_processing_record_docs_implementation_90_traceability_source_breakdown_roadmap_backlog_open_questions.md`

| Prompt ID | Prompt file | Current crate | Current module | Source file | Source SHA256 |
|---|---|---|---|---|---|
| `CODEX-1033-90-TRACEABILITY-472c9c6961` | `codex-prompts/90-traceability/P0063.md` | `trpg-docs-governance` | `traceability::source_processing_record_docs_implementation_90_traceability_source_breakdown_roadmap_backlog_open_questions` | `docs/implementation/90-traceability/per-file-code-ready/90-traceability/docs-implementation-90-traceability-source-processing-90-traceability-docs-implementation-90-traceability-sour-360535ed92.v5-code-ready.md` | `1aa0ed3e190555e49e7b9b53d713711c4971983d4184bade7fc43fa1bbfd4aa5` |
...
- `CODEX-1033-90-TRACEABILITY-472c9c6961`: implemented as docs-only traceability.
