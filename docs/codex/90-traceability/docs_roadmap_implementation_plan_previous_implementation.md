# docs roadmap implementation plan previous implementation
...
- Current output: docs/codex/90-traceability/docs_roadmap_implementation_plan_previous_implementation.md

| Prompt ID | Prompt file | Current crate | Current module | Source file | Source SHA256 |
|---|---|---|---|---|---|
| CODEX-0989-90-TRACEABILITY-7b67092361 | codex-prompts/90-traceability/P0022.md | trpg-docs-governance | traceability::docs_roadmap_implementation_plan_previousimplementation | docs/implementation/90-traceability/per-file-code-ready/90-traceability/docs-implementation-90-traceability-generated-from-source-docs-roadmap-implementation-plan-v4-implementation-84c0a23ae6.v5-code-ready.md | 5db8714547fbdfeeb6c086e4285d588a539882853dcbc529756a3f8636995dd3 |
...
- CODEX-0989-90-TRACEABILITY-7b67092361: implemented as docs-only traceability; test responsibility is covered by B046 prompt coverage, current-safe output, docs-only boundary, and provenance checks in evidence/batches/BATCH-046/test-output.txt.
