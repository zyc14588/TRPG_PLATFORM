...
- Current output: docs/codex/90-traceability/manifest_source_boundary.md

| Prompt ID | Prompt file | Current crate | Current module | Source file | Source SHA256 |
|---|---|---|---|---|---|
| CODEX-0977-90-TRACEABILITY-0620446feb | codex-prompts/90-traceability/P0010.md | trpg-docs-governance | traceability::manifest_source_boundary | docs/implementation/90-traceability/per-file-code-ready/90-traceability/docs-implementation-00-index-manifest-source-boundary-bf6fec9fb1.v5-code-ready.md | c892c5b9ffcd97386b5997ae7f6bbfec7c95acc166ca63712027a0063a26972d |
...
- CODEX-0977-90-TRACEABILITY-0620446feb: implemented as docs-only traceability; test responsibility is covered by B046 prompt coverage, current-safe output, docs-only boundary, and provenance checks in evidence/batches/BATCH-046/test-output.txt.
