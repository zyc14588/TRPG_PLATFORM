...
- Current output: docs/codex/90-traceability/docs_implementation.md

| Prompt ID | Prompt file | Current crate | Current module | Source file | Source SHA256 |
|---|---|---|---|---|---|
| CODEX-0974-90-TRACEABILITY-43acdc80df | codex-prompts/90-traceability/P0006.md | trpg-docs-governance | traceability::docs_implementation | docs/implementation/90-traceability/per-file-code-ready/90-traceability/docs-implementation-00-index-generated-from-source-strict-docs-implementation-readme-strict-v4-36f73ca09c.v5-code-ready.md | 23e20bcb69feac42e785700afc4a56a69d9e2a9f63ca48e61b65b08ba7270d58 |
...
- CODEX-0974-90-TRACEABILITY-43acdc80df: implemented as docs-only traceability; test responsibility is covered by B046 prompt coverage, current-safe output, docs-only boundary, and provenance checks in evidence/batches/BATCH-046/test-output.txt.
