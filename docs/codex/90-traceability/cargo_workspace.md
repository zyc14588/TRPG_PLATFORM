...
- Current output: docs/codex/90-traceability/cargo_workspace.md

| Prompt ID | Prompt file | Current crate | Current module | Source file | Source SHA256 |
|---|---|---|---|---|---|
| CODEX-0997-90-TRACEABILITY-e68dd8440b | codex-prompts/90-traceability/P0041.md | trpg-docs-governance | traceability::cargo_workspace | docs/implementation/90-traceability/per-file-code-ready/90-traceability/docs-implementation-90-traceability-generated-from-source-strict-docs-implementation-90-traceability-source-br-1dc077e9c5.v5-code-ready.md | 9b686aa00c8e9848e8837688645d26f67516086d0afe7be605768f66e95556ac |
...
- CODEX-0997-90-TRACEABILITY-e68dd8440b: implemented as docs-only traceability; test responsibility is covered by B047 prompt coverage, current-safe output, docs-only boundary, and provenance checks in evidence/batches/BATCH-047/test-output.txt.
