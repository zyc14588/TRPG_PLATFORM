# source processing record docs implementation 00 index readme
...
- Current output: `docs/codex/90-traceability/source_processing_record_docs_implementation_00_index_readme.md`

| Prompt ID | Prompt file | Current crate | Current module | Source file | Source SHA256 |
|---|---|---|---|---|---|
| `CODEX-1025-90-TRACEABILITY-464adaf897` | `codex-prompts/90-traceability/P0052.md` | `trpg-docs-governance` | `traceability::source_processing_record_docs_implementation_00_index_readme` | `docs/implementation/90-traceability/per-file-code-ready/90-traceability/docs-implementation-90-traceability-source-processing-00-index-docs-implementation-00-index-readme-processed-426bfd8f66.v5-code-ready.md` | `89d012bf5a08bc222001840c688a91ca85c5ea5458822f1af8f6ed6c6c7695b5` |
...
- `CODEX-1025-90-TRACEABILITY-464adaf897`: implemented as docs-only traceability.
