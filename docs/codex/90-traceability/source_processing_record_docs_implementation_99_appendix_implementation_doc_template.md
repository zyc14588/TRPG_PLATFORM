# source processing record docs implementation 99 appendix implementation doc template
...
- Current output: `docs/codex/90-traceability/source_processing_record_docs_implementation_99_appendix_implementation_doc_template.md`

| Prompt ID | Prompt file | Current crate | Current module | Source file | Source SHA256 |
|---|---|---|---|---|---|
| `CODEX-1043-90-TRACEABILITY-9d470d0b7c` | `codex-prompts/90-traceability/P0076.md` | `trpg-docs-governance` | `traceability::source_processing_record_docs_implementation_99_appendix_implementation_doc_template` | `docs/implementation/90-traceability/per-file-code-ready/90-traceability/docs-implementation-90-traceability-source-processing-99-appendix-docs-implementation-99-appendix-implementati-756b1a3d45.v5-code-ready.md` | `6aef628cfe855f7127f25b773f8a6585ea5d65d005d089bfa3f8fe7005833037` |
...
- `CODEX-1043-90-TRACEABILITY-9d470d0b7c`: implemented as docs-only traceability.
