...
- Current output: docs/codex/90-traceability/memory_rag.md

| Prompt ID | Prompt file | Current crate | Current module | Source file | Source SHA256 |
|---|---|---|---|---|---|
| CODEX-1000-90-TRACEABILITY-10b80d60f4 | codex-prompts/90-traceability/P0025.md | trpg-docs-governance | traceability::memory_rag | docs/implementation/90-traceability/per-file-code-ready/90-traceability/docs-implementation-90-traceability-generated-from-source-strict-docs-implementation-90-traceability-source-br-37e8ef1dc1.v5-code-ready.md | 53b57fd993c5a23e51c6b2ca59f3685f45f6eec20f5f89a525e6ba4f192ed7da |
...
- CODEX-1000-90-TRACEABILITY-10b80d60f4: implemented as docs-only traceability; test responsibility is covered by B047 prompt coverage, current-safe output, docs-only boundary, and provenance checks in evidence/batches/BATCH-047/test-output.txt.
