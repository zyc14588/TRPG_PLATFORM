# source processing record docs implementation 90 traceability adr trace
...
- Current output: `docs/codex/90-traceability/source_processing_record_docs_implementation_90_traceability_adr_trace.md`

| Prompt ID | Prompt file | Current crate | Current module | Source file | Source SHA256 |
|---|---|---|---|---|---|
| `CODEX-1027-90-TRACEABILITY-cbe6adc163` | `codex-prompts/90-traceability/P0066.md` | `trpg-docs-governance` | `traceability::source_processing_record_docs_implementation_90_traceability_adr_trace` | `docs/implementation/90-traceability/per-file-code-ready/90-traceability/docs-implementation-90-traceability-source-processing-90-traceability-docs-implementation-90-traceability-adr-df0024c766.v5-code-ready.md` | `c58eec260461d36957034cbe371b9d5fca3ec29f0ddd948ef267b9c995a4c8df` |
...
- `CODEX-1027-90-TRACEABILITY-cbe6adc163`: implemented as docs-only traceability.
