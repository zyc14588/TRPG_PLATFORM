...
- Current output: docs/codex/90-traceability/backlog.md

| Prompt ID | Prompt file | Current crate | Current module | Source file | Source SHA256 |
|---|---|---|---|---|---|
| CODEX-0988-90-TRACEABILITY-1e58be8710 | codex-prompts/90-traceability/P0021.md | trpg-docs-governance | traceability::backlog | docs/implementation/90-traceability/per-file-code-ready/90-traceability/docs-implementation-90-traceability-generated-from-source-docs-roadmap-backlog-open-questions-v4-implementatio-f1a49c6489.v5-code-ready.md | d521d068e5ba75402be53d1688f4e46927aa7178d0f187aa284d929610b888ec |
...
- CODEX-0988-90-TRACEABILITY-1e58be8710: implemented as docs-only traceability; test responsibility is covered by B046 prompt coverage, current-safe output, docs-only boundary, and provenance checks in evidence/batches/BATCH-046/test-output.txt.
