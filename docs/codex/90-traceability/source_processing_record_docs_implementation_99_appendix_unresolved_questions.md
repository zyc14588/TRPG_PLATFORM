# source processing record docs implementation 99 appendix unresolved questions
...
- Current output: `docs/codex/90-traceability/source_processing_record_docs_implementation_99_appendix_unresolved_questions.md`

| Prompt ID | Prompt file | Current crate | Current module | Source file | Source SHA256 |
|---|---|---|---|---|---|
| `CODEX-1046-90-TRACEABILITY-e1eaaefb1a` | `codex-prompts/90-traceability/P0079.md` | `trpg-docs-governance` | `traceability::source_processing_record_docs_implementation_99_appendix_unresolved_questions` | `docs/implementation/90-traceability/per-file-code-ready/90-traceability/docs-implementation-90-traceability-source-processing-99-appendix-docs-implementation-99-appendix-unresolved-q-4a797e34cf.v5-code-ready.md` | `aac16b4e6db2c3a38eac75170c6a5b412d954822cae209e6c0cb2e45a1179b54` |
...
- `CODEX-1046-90-TRACEABILITY-e1eaaefb1a`: implemented as docs-only traceability.
