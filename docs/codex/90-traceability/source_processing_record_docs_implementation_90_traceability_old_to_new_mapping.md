# source processing record docs implementation 90 traceability old to new mapping
...
- Current output: `docs/codex/90-traceability/source_processing_record_docs_implementation_90_traceability_old_to_new_mapping.md`

| Prompt ID | Prompt file | Current crate | Current module | Source file | Source SHA256 |
|---|---|---|---|---|---|
| `CODEX-1029-90-TRACEABILITY-61ffcc7818` | `codex-prompts/90-traceability/P0064.md` | `trpg-docs-governance` | `traceability::source_processing_record_docs_implementation_90_traceability_historical_to_current_mapping` | `docs/implementation/90-traceability/per-file-code-ready/90-traceability/docs-implementation-90-traceability-source-processing-90-traceability-docs-implementation-90-traceability-old-cd970cab50.v5-code-ready.md` | `754ecf9dabadd6562de973d8b50fce5d9948b72d863c7a41987ef1e1499ef21f` |
...
- `CODEX-1029-90-TRACEABILITY-61ffcc7818`: implemented as docs-only traceability.
