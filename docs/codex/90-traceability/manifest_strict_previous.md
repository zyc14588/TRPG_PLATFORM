...
- Current output: docs/codex/90-traceability/manifest_strict_previous.md

| Prompt ID | Prompt file | Current crate | Current module | Source file | Source SHA256 |
|---|---|---|---|---|---|
| CODEX-0975-90-TRACEABILITY-dad3e66ca6 | codex-prompts/90-traceability/P0008.md | trpg-docs-governance | traceability::manifest_previous_provenance | docs/implementation/90-traceability/per-file-code-ready/90-traceability/docs-implementation-00-index-generated-from-source-strict-manifest-strict-v4-84e2df99ba.v5-code-ready.md | 72a7e97b13f63e9f5a188553145b46730487ac69c4002712a8edcf4be9b9208e |
...
- CODEX-0975-90-TRACEABILITY-dad3e66ca6: implemented as docs-only traceability; test responsibility is covered by B046 prompt coverage, current-safe output, docs-only boundary, and provenance checks in evidence/batches/BATCH-046/test-output.txt.
