# docs implementation 00 index readme strict previous
...
- Current output: docs/codex/90-traceability/docs_implementation_00_index_readme_strict_previous.md

| Prompt ID | Prompt file | Current crate | Current module | Source file | Source SHA256 |
|---|---|---|---|---|---|
| CODEX-0973-90-TRACEABILITY-2904f797c3 | codex-prompts/90-traceability/P0005.md | trpg-docs-governance | traceability::docs_implementation_00_index_readme_previous_provenance | docs/implementation/90-traceability/per-file-code-ready/90-traceability/docs-implementation-00-index-generated-from-source-strict-docs-implementation-00-index-readme-strict-v4-6f5e496051.v5-code-ready.md | f78c1045195ecdaeb1ce4e0c749c242a8b4d3bb92e8a5314b4ce427ae2d12dec |
...
- CODEX-0973-90-TRACEABILITY-2904f797c3: implemented as docs-only traceability; test responsibility is covered by B046 prompt coverage, current-safe output, docs-only boundary, and provenance checks in evidence/batches/BATCH-046/test-output.txt.
