...
- Current output: docs/codex/90-traceability/session_runtime.md

| Prompt ID | Prompt file | Current crate | Current module | Source file | Source SHA256 |
|---|---|---|---|---|---|
| CODEX-1006-90-TRACEABILITY-972996e232 | codex-prompts/90-traceability/P0035.md | trpg-docs-governance | traceability::session_runtime | docs/implementation/90-traceability/per-file-code-ready/90-traceability/docs-implementation-90-traceability-generated-from-source-strict-docs-implementation-90-traceability-source-br-ab51022b61.v5-code-ready.md | 18e53c54847c3439770b9bb652182f5627fbc8886cc07707b64029090e7fd989 |
...
- CODEX-1006-90-TRACEABILITY-972996e232: implemented as docs-only traceability; test responsibility is covered by B047 prompt coverage, current-safe output, docs-only boundary, and provenance checks in evidence/batches/BATCH-047/test-output.txt.
