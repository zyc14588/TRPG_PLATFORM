# source processing record docs implementation 90 traceability source breakdown roadmap implementation plan
...
- Current output: `docs/codex/90-traceability/source_processing_record_docs_implementation_90_traceability_source_breakdown_roadmap_implementation_plan.md`

| Prompt ID | Prompt file | Current crate | Current module | Source file | Source SHA256 |
|---|---|---|---|---|---|
| `CODEX-1034-90-TRACEABILITY-fa75025ff7` | `codex-prompts/90-traceability/P0068.md` | `trpg-docs-governance` | `traceability::source_processing_record_docs_implementation_90_traceability_source_breakdown_roadmap_implementation_plan` | `docs/implementation/90-traceability/per-file-code-ready/90-traceability/docs-implementation-90-traceability-source-processing-90-traceability-docs-implementation-90-traceability-sour-f336deef05.v5-code-ready.md` | `430e2ba790100bd3325c35a999218e9a0233a5f38621d79eaa7c70e941e502ff` |
...
- `CODEX-1034-90-TRACEABILITY-fa75025ff7`: implemented as docs-only traceability.
