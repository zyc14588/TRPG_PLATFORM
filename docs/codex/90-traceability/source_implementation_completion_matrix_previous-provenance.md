# source implementation completion matrix previous provenance
...
- Current output: `docs/codex/90-traceability/source_implementation_completion_matrix_previous-provenance.md`

| Prompt ID | Prompt file | Current crate | Current module | Source file | Source SHA256 |
|---|---|---|---|---|---|
| `CODEX-1018-90-TRACEABILITY-17a69c1cec` | `codex-prompts/90-traceability/P0051.md` | `trpg-docs-governance` | `traceability::source_implementation_completion_matrix_previousstrict` | `docs/implementation/90-traceability/per-file-code-ready/90-traceability/docs-implementation-90-traceability-source-implementation-completion-matrix-v4-strict-e376da02fe.v5-code-ready.md` | `f9386285b0630f76241bb3c0f1c049bdbcb2ab6a2c6ceddcf770885a3821ce7f` |
...
- `CODEX-1018-90-TRACEABILITY-17a69c1cec`: implemented as docs-only traceability.
