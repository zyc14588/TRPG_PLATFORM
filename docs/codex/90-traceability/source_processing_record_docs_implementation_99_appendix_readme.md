# source processing record docs implementation 99 appendix readme
...
- Current output: `docs/codex/90-traceability/source_processing_record_docs_implementation_99_appendix_readme.md`

| Prompt ID | Prompt file | Current crate | Current module | Source file | Source SHA256 |
|---|---|---|---|---|---|
| `CODEX-1045-90-TRACEABILITY-9a9028f88f` | `codex-prompts/90-traceability/P0075.md` | `trpg-docs-governance` | `traceability::source_processing_record_docs_implementation_99_appendix_readme` | `docs/implementation/90-traceability/per-file-code-ready/90-traceability/docs-implementation-90-traceability-source-processing-99-appendix-docs-implementation-99-appendix-readme-proce-79aacdffc9.v5-code-ready.md` | `23247c5370c48e4e62f0cf51cb665e85b0e898b2d478010118498f43265b2bea` |
...
- `CODEX-1045-90-TRACEABILITY-9a9028f88f`: implemented as docs-only traceability.
