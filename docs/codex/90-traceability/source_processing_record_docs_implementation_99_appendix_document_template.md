# source processing record docs implementation 99 appendix document template
...
- Current output: `docs/codex/90-traceability/source_processing_record_docs_implementation_99_appendix_document_template.md`

| Prompt ID | Prompt file | Current crate | Current module | Source file | Source SHA256 |
|---|---|---|---|---|---|
| `CODEX-1040-90-TRACEABILITY-d2d5dcf423` | `codex-prompts/90-traceability/P0078.md` | `trpg-docs-governance` | `traceability::source_processing_record_docs_implementation_99_appendix_document_template` | `docs/implementation/90-traceability/per-file-code-ready/90-traceability/docs-implementation-90-traceability-source-processing-99-appendix-docs-implementation-99-appendix-document-tem-498446cbd0.v5-code-ready.md` | `a9f451b95d06119655b411622b1adb65c80a41a809641546ba9896e74cbd2b21` |
...
- `CODEX-1040-90-TRACEABILITY-d2d5dcf423`: implemented as docs-only traceability.
