# source processing record docs implementation 00 index reading path
...
- Current output: `docs/codex/90-traceability/source_processing_record_docs_implementation_00_index_reading_path.md`

| Prompt ID | Prompt file | Current crate | Current module | Source file | Source SHA256 |
|---|---|---|---|---|---|
| `CODEX-1024-90-TRACEABILITY-d824d01fa3` | `codex-prompts/90-traceability/P0058.md` | `trpg-docs-governance` | `traceability::source_processing_record_docs_implementation_00_index_reading_path` | `docs/implementation/90-traceability/per-file-code-ready/90-traceability/docs-implementation-90-traceability-source-processing-00-index-docs-implementation-00-index-reading-path-proce-699aeb53cd.v5-code-ready.md` | `7942859215d08935e4e5b99ba1effc5fe0bd6cf077c7d9b27be6e6ba8cb025f9` |
...
- `CODEX-1024-90-TRACEABILITY-d824d01fa3`: implemented as docs-only traceability.
