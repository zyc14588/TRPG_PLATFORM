...
> BATCH-051 current-safe documentation output. Definitions defer to the current
...
The glossary defines terms; it does not define new product scope. B051 checks
both owners, source metadata, map agreement, table shape, forbidden historical
current naming, and retained governance semantics.
