> [v2.21 自包含来源清理标记]
> 原始路径：`docs/codex/99-appendix/AGENTS.md`
...
# AGENTS.md — 99-appendix Codex 模块规则

本文件是 `99-appendix` 模块的局部 Codex 指令。执行该模块相关代码前，先读取仓库根 `AGENTS.md`，再读取本文件。

## 模块范围

Appendix / templates / glossary / research notes
