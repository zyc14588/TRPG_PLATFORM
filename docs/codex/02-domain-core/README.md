> [v2.21 自包含来源清理标记]
> 原始路径：`docs/codex/02-domain-core/README.md`
...
# 02-domain-core — Codex 模块施工目录

范围：Domain core / command / authority / visibility
默认 crate：`trpg-domain-core`
默认 module prefix：`domain_core`
Per-file prompts：106

## 模块关键要求

authority、visibility、fact provenance、command idempotency 是全系统写路径的基础。
...
- per-file prompts：`codex-prompts/02-domain-core/`
