> [v2.21 自包含来源清理标记]
> 原始路径：`docs/codex/02-domain-core/AGENTS.md`
...
# AGENTS.md — 02-domain-core Codex 模块规则

本文件是 `02-domain-core` 模块的局部 Codex 指令。执行该模块相关代码前，先读取仓库根 `AGENTS.md`，再读取本文件。

## 模块范围

Domain core / command / authority / visibility
