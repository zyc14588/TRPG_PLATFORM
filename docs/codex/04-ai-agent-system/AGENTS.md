> [v2.21 自包含来源清理标记]
> 原始路径：`docs/codex/04-ai-agent-system/AGENTS.md`
...
# AGENTS.md — 04-ai-agent-system Codex 模块规则

本文件是 `04-ai-agent-system` 模块的局部 Codex 指令。执行该模块相关代码前，先读取仓库根 `AGENTS.md`，再读取本文件。

## 模块范围

AI agent runtime / model provider / tool protocol / RAG
