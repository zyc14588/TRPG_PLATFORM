> [v2.21 自包含来源清理标记]
> 原始路径：`docs/codex/04-ai-agent-system/README.md`
...
# 04-ai-agent-system — Codex 模块施工目录

范围：AI agent runtime / model provider / tool protocol / RAG
默认 crate：`trpg-agent-runtime`
默认 module prefix：`agent_runtime`
Per-file prompts：95

## 模块关键要求

Agent 只能提出 Proposal / ToolCall / DraftDecision，严禁直接写正式状态。
...
- per-file prompts：`codex-prompts/04-ai-agent-system/`
