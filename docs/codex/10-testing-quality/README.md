> [v2.21 自包含来源清理标记]
> 原始路径：`docs/codex/10-testing-quality/README.md`
...
# 10-testing-quality — Codex 模块施工目录

范围：Golden tests / contract tests / replay / model certification
默认 crate：`trpg-testing`
默认 module prefix：`testing_quality`
Per-file prompts：78

## 模块关键要求

Golden/replay/contract/visibility leakage tests 是合并门禁。
...
- per-file prompts：`codex-prompts/10-testing-quality/`
